...
from gpm.hierarchy_geom import DocumentHierarchy, HierarchyNode, TokenSpan, intervals_overlap
...
@dataclass
class _LayerIndex:
    """Segmentbaum über Token-Indizes [0, n)."""
...
@dataclass
class IntervalIndex:
    """Index über alle Hierarchie-Ebenen pro Dokument."""
...
def build_interval_index(hierarchy: DocumentHierarchy, token_count: int) -> IntervalIndex:
    """Baut einen statischen Index aus der Dokument-Hierarchie."""
