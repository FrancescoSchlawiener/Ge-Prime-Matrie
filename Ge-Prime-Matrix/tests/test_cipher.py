...
class TestCipher(unittest.TestCase):
    ...
    def test_roundtrip_hardcore_mixed_keys(self):
        ...
        self.assertIn(enc["security"]["level"], ("hoch", "sehr hoch"))
    ...
    def test_hardcore_requires_two_keys(self):
        with self.assertRaises(ValueError):
            encrypt_text("Test", mode=MODE_HARDCORE, keys_raw="NurEins")
    ...
    def test_assess_security_hardcore_bonus(self):
        sec = assess_security(MODE_HARDCORE, [parse_key_token("A"), parse_key_token("B"), parse_key_token("prime:17")])
