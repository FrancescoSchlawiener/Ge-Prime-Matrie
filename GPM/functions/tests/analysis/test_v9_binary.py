...
from analysis.binary.format import VERSION, VERSION_V9, read_gpm
...
class TestV9Binary(unittest.TestCase):
    ...
    def test_v9_roundtrip_geometry(self):
        doc, blob, _ = compile_text_to_gpm("Hallo Welt.", AlphabetProfile.OG, version=VERSION_V9)
    ...
    def test_v9_multiline_roundtrip(self):
        source = "Erster Satz.\nZweiter Satz."
        _, blob, _ = compile_text_to_gpm(source, AlphabetProfile.OG, version=VERSION_V9)
        loaded = read_gpm(blob)
