...
class TestRelationProfile(unittest.TestCase):
    ...
    def test_build_profile_has_bigrams(self):
        doc, _ = compile_text(self.DE_MED, AlphabetProfile.OG)
    ...
    def test_similar_texts_higher_relation_score(self):
        ...
        doc_b, _ = compile_text(self.DE_MED2, AlphabetProfile.OG)
        doc_c, _ = compile_text(
            "Software Server Algorithmus Netzwerk Cloud Programm", AlphabetProfile.OG
        )
